# Generated by Powerlevel10k configuration wizard on 2019-11-09 at 11:51 GMT.
...
() {
  ...
  typeset -g POWERLELVEL9K_DIR_PATH_SEPARATOR_FOREGROUNG=247
  ...
  typeset -g POWERLEVEL9K_VCS_BACKGROUND=233
  POWERLEVEL9K_VCS_BACKGROUND=${(g::)POWERLEVEL9K_VCS_BACKGROUND}

  #typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=143
  #POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=${(g::)POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND}


  #typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=143
  #POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=${(g::)POWERLEVEL9K_VCS_MODIFIED_BACKGROUND}
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local  untracked='%214F'  # blue foreground
    ...
    # *42 if have stashes.
    (( VCS_STATUS_STASHES        )) && res+=" ${stashed}${POWERLEVEL9K_VCS_STASHED_ICON}${VCS_STATUS_STASHES}"
    ...
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+=" ${unstaged}${POWERLEVEL9K_VCS_UNSTAGED_ICON}${VCS_STATUS_NUM_UNSTAGED}"
